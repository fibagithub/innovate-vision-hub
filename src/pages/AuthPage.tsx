  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      if (error.message.includes('User already registered')) {
        toast.error('Энэ имэйл хаяг бүртгэлтэй байна');
      } else {
        toast.error(error.message);
      }
    } else {
      toast.success('Бүртгэл амжилттай! Та нэвтрэх боломжтой.');
    }
    setIsLoading(false);
  };
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <span className="font-display font-bold text-2xl text-foreground">FocusTech</span>
        </div>

        <Card className="w-full max-w-md border-border/50 bg-card/80 backdrop-blur-xl shadow-2xl">
          <CardHeader className="text-center pb-2">
            <CardTitle className="font-display text-2xl">Админ нэвтрэх</CardTitle>
            <CardDescription>
              Админ панел руу нэвтрэхийн тулд имэйл, нууц үгээ оруулна уу
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="signin-email">Имэйл</Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signin-password">Нууц үг</Label>
                    <div className="relative">
