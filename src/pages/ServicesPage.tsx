...
import { ArrowRight, ArrowLeft, Check, Database, FileText, Smartphone, CreditCard, BarChart3, Sparkles, Play, Shield, Zap, Globe, Users, Building2, TrendingUp } from 'lucide-react';
...
const products = [
  {
    ...
    description: 'БАНК, ББСБ, Лизинг болон ХЗХ зэрэг санхүүгийн үйлчилгээг үзүүлдэг байгууллагуудад зориулагдсан өдөр тутмын үйл ажиллагааг автоматжуулах цогц систем.',
    ...
    features: [
      ...
      { title: 'Тайлан системk', desc: 'Санхүүгийн болон удирдлагын тайлангууд' },
  ...
  },
  {
    ...
    description: 'Зээл олгох үйл явцыг автоматжуулах, хянах, удирдах зориулалттай систем. Зээлийн хүсэлт хүлээн авахаас эхлээд олголт хүртэл бүх үе шатыг удирдана.',
  ...
  },
  {
    ...
    description: 'ХЗХ болон ББСБ-н гишүүд харилцагч нарыг онлайнаар үйлчилгээ авах боломжийг олгох мобайл банкны аппликейшн.',
    ...
    benefits: [
      '24/7 банкны үйлчилгээ',
      'Салбарт очих шаардлагагүй',
      'Хурдан, аюулгүй гүйлгээ',
      'Хялбар интерфейс',
    ],
  },
  {
    ...
    description: 'EMV стандарт бүхий VISA, MASTER CARD, UnionPay терминал. POS терминалын цогц шийдэл, төлбөрийн карт хүлээн авах боломж.',
  ...
  },
  {
    ...
    description: 'ТИТАН Си Ар Эй Зээлийн мэдээллийн систем. Иргэн, байгууллагын зээлийн түүх, скоринг, риск үнэлгээний цогц шийдэл.',
    ...
    benefits: [
      'Зээлийн шийдвэр хурдан гаргана',
      'Риск бууруулна',
      'Найдвартай мэдээлэл',
      'Хуулийн дагуу ажиллана',
    ],
  },
];
    ...
    return (
      <Layout>
        ...
        <section className="relative pt-32 pb-24 overflow-hidden">
          ...
          {/* Floating Elements */}
          <div className={`absolute top-20 right-[10%] w-[400px] h-[400px] bg-gradient-to-br ${product.gradient} opacity-10 rounded-full blur-3xl`} />
          <div className={`absolute bottom-0 left-[5%] w-[300px] h-[300px] bg-gradient-to-br ${product.gradient} opacity-5 rounded-full blur-3xl`} />
          
          <div className="container mx-auto px-4 relative">
            <Link to="/services" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-8 transition-colors group">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <span className="text-sm font-bold tracking-widest uppercase mb-4 block" style={{ 
              ...
              <div className="grid grid-cols-2 gap-4">
                {product.stats.map((stat, index) => (
                  ...
                  >
                    <div className={`text-4xl lg:text-5xl font-bold mb-2 bg-gradient-to-r ${product.gradient} bg-clip-text text-transparent`}>
                      {stat.value}
                    </div>
        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r ${product.gradient} bg-opacity-10 mb-6`}>
                ...
                <div className="space-y-4">
                  {product.benefits.map((benefit, index) => (
                    <div key={index} className="flex items-center gap-4 p-4 rounded-2xl bg-muted/50 hover:bg-muted transition-colors">
                      <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${product.gradient} flex items-center justify-center shrink-0`}>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                Манай бусад технологийн шийдлүүдтэй танилцана уу
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.filter(p => p.id !== serviceId).map((p) => {
              ...
              return (
                <div key={product.id} className={sizeClass}>
                  <CardWrapper {...linkProps as any} className="block h-full">
                    <div className={`group relative h-full ${minHeight} p-8 lg:p-10 rounded-[2rem] bg-gradient-to-br ${product.bgGradient} bg-card border border-border/50 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:border-primary/20`}>
                      {/* Gradient Accent */}
                      <div className={`absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r ${product.gradient}`} />
                      
                      {/* Decorative */}
                      <div className={`absolute top-10 right-10 w-32 h-32 bg-gradient-to-br ${product.gradient} opacity-10 rounded-full blur-3xl group-hover:opacity-20 transition-opacity`} />
                      ...
                      <div className="relative h-full flex flex-col">
                        ...
                        <span className="text-xs font-bold tracking-widest uppercase mb-2" style={{ 
                          background: `linear-gradient(to right, ${product.gradient.includes('primary') ? 'hsl(var(--primary))' : product.gradient.split(' ')[0].replace('from-[', '').replace(']', '')}, ${product.gradient.split(' ')[1].replace('to-[', '').replace(']', '')})`,
                          WebkitBackgroundClip: 'text',
                          WebkitTextFillColor: 'transparent'
                        }}>
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-border/50">
                          <div className="flex items-center gap-2">
                            <Sparkles className="w-4 h-4" style={{ 
                              color: product.gradient.includes('primary') ? 'hsl(var(--primary))' : product.gradient.split(' ')[0].replace('from-[', '').replace(']', '')
                            }} />
