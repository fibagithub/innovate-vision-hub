...
const fallbackTeamMembers = [
  {
    ...
    bio: "Payment systems, Banking systems, 20 years of experience.",
  ...
  },
  {
    ...
    bio: "Banking information systems, 19 years of experience.",
  ...
  },
  {
    ...
    bio: "System analysis, Data center, 16 years of experience.",
  ...
  },
  {
    ...
    bio: "Software, Algorithms, 17 years of experience.",
...
const TeamMemberCard = ({
  ...
  const memberName =
    language === "mn"
      ? ("name_mn" in member ? member.name_mn : null) || member.name
      : member.name || ("name_mn" in member ? member.name_mn : null);
  const position =
    language === "mn"
      ? member.position_mn || ("position" in member ? member.position : "")
      : ("position" in member ? member.position : "") || member.position_mn;
  const bio =
    language === "mn"
      ? member.bio_mn || ("bio" in member ? member.bio : "")
      : ("bio" in member ? member.bio : "") || member.bio_mn;
...
export function Team() {
  ...
  return (
    <section className="py-32 relative overflow-hidden" id="team">
      ...
      {expandedMember && (
        <ProfileModal member={expandedMember} onClose={() => setExpandedMember(null)} language={language} t={t} />
      )}
    </section>
  );
}
