...
const allProducts = [
  ...
  },
  {
    ...
    features: [
      ...
      "Мэдэгдэл",
      "Онлайн үйлчилгээ",
      "Хэрэглэгчийн хялбар нэвтрэлт",
      "Бүх дансны удирдлага",
    ],
  ...
  },
  {
    ...
    features: ["Картын төлбөр", "EMV чип", "Contactless", "QR төлбөр", "Терминал интеграц"],
  ...
  },
  {
    ...
    features: ["Зээлийн түүх", "Скоринг", "Риск үнэлгээ", "Лавлагаа"],
