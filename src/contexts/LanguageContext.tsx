...
const translations: Translations = {
  ...
  'hero.description': { mn: 'Банк санхүүгийн програм хангамж, төлбөр тооцооны систем, мэдээллийн сан зохион байгуулах чиглэлээр 15+ жилийн туршлагатай мэргэжлийн баг', en: 'A professional team with 15+ years of experience in banking software, payment systems, and database management' },
  ...
  'about.desc1': { mn: 'Манай компани нь 2021 онд байгуулагдсан бөгөөд, банк санхүүгийн Програм хангамж, түүний шийдэл, мэдээллийн сан зохион байгуулах, төлбөр тооцооны шийдэл боловсруулах чиглэлээр үйл ажиллагаа явуулдаг.', en: 'Our company was founded in 2021 and operates in the field of banking software, solutions, database management, and payment system development.' },
  'about.desc2': { mn: 'Мөн банк санхүүгийн мэдээллийн систем, Програм хангамж, мэдээллийн сан болон түүний нууцлал аюулгүй байдлыг хариуцан ажиллаж байсан тухайн салбартаа олон жилийн мэдлэг туршлага хуримтлуулсан чадварлаг, бүтээлч хамт олноос бүрдэж байна.', en: 'Our team consists of talented and creative professionals who have accumulated years of knowledge and experience in banking information systems, software, database management, and security.' },
  'about.learnMore': { mn: 'Дэлгэрэнгүй үзэх', en: 'Learn More' },
  'about.feature.experience': { mn: 'Туршлага', en: 'Experience' },
  'about.feature.experienceDesc': { mn: 'Тэргүүлэгч банкны олон жилийн туршлагад суурилагдан бүтээгдсэн', en: 'Built on years of experience with leading banks' },
  'about.feature.reliable': { mn: '24/7 Найдвартай', en: '24/7 Reliable' },
  'about.feature.reliableDesc': { mn: 'Найдвартай ажиллагаа, мэдээллийн аюулгүй байдлыг хангасан', en: 'Reliable operations with ensured data security' },
  'about.feature.support': { mn: 'Мэргэжлийн дэмжлэг', en: 'Professional Support' },
  'about.feature.supportDesc': { mn: 'Мэргэжлийн өндөр түвшний ашиглалт үйлчилгээ үзүүлдэг', en: 'Providing high-level professional maintenance and service' },
  'about.value.mission': { mn: 'Бидний эрхэм зорилго', en: 'Our Mission' },
  'about.value.missionDesc': { mn: 'Банк санхүүгийн байгууллагуудад дэлхийн жишигт нийцсэн, найдвартай, хэрэглэхэд хялбар технологийн шийдэл бүтээх.', en: 'To create reliable, user-friendly technology solutions that meet global standards for financial institutions.' },
  'about.value.vision': { mn: 'Бидний алсын хараа', en: 'Our Vision' },
  'about.value.visionDesc': { mn: 'Монголын санхүүгийн салбарын технологийн тэргүүлэгч компани болж, олон улсын зах зээлд гарах.', en: 'To become the leading technology company in Mongolia\'s financial sector and expand to international markets.' },
  'about.value.values': { mn: 'Бидний үнэт зүйлс', en: 'Our Values' },
  'about.value.valuesDesc': { mn: 'Мэргэжлийн ёс зүй, найдвартай байдал, тасралтгүй хөгжил, харилцагчийн сэтгэл ханамж бидний үнэт зүйлс.', en: 'Professional ethics, reliability, continuous development, and client satisfaction are our core values.' },
  ...
  'why.description': { mn: 'Бид таны санааг бодит болгох, бизнесийг тэлэх инновацлаг шийдлүүдийг санал болгодог', en: 'We offer innovative solutions to turn your ideas into reality and grow your business' },
  'why.innovation': { mn: 'Инноваци', en: 'Innovation' },
  'why.innovationSub': { mn: 'Дэвшилтэт технологи', en: 'Advanced Technology' },
  'why.innovationDesc': { mn: 'Хамгийн сүүлийн үеийн технологийг ашиглан үйлчлүүлэгчдийнхээ бизнесийг хөгжүүлнэ', en: 'Developing our clients\' business using the latest technology' },
  ...
  'why.securityDesc': { mn: 'Олон улсын аюулгүй байдлын стандартад нийцсэн системүүдийг хөгжүүлнэ', en: 'Developing systems that meet international security standards' },
  ...
  'why.speedDesc': { mn: 'Agile арга зүйгээр хурдан, үр дүнтэй шийдлүүдийг бүтээнэ', en: 'Building fast, effective solutions using Agile methodology' },
  ...
  'why.teamDesc': { mn: 'Тэргүүлэгч банкуудад ажиллаж байсан мэргэжилтнүүдийн баг', en: 'A team of professionals who have worked at leading banks' },
  ...
  'why.cta.desc': { mn: 'Таны бизнесийн хэрэгцээнд тохирсон шийдлийг бид хамтдаа бүтээцгээе', en: 'Let\'s build the right solution for your business needs together' },
  ...
  'team.description': { mn: 'Банк санхүүгийн салбарт олон жилийн туршлагатай мэргэжлийн баг', en: 'A professional team with years of experience in the banking and finance sector' },
  ...
  'teamPage.heroDesc': { mn: 'Манай чадварлаг баг нь банк санхүүгийн технологийн чиглэлээр олон жилийн туршлага, мэдлэгээ нэгтгэн, шилдэг шийдлүүдийг бүтээдэг.', en: 'Our talented team combines years of experience and knowledge in financial technology to create the best solutions.' },
  ...
  'teamPage.joinDesc': { mn: 'Бид үргэлж технологид хайртай, бүтээлч сэтгэлгээтэй хүмүүстэй хамтран ажиллахыг хүсдэг.', en: 'We are always looking to work with people who love technology and have creative thinking.' },
  ...
  'servicesPage.otherProductsDesc': { mn: 'Манай бусад технологийн шийдлүүдтэй танилцана уу', en: 'Explore our other technology solutions' },
  'servicesPage.innovativeDesc': { mn: 'Таны бизнесийг дараагийн түвшинд хүргэх инновацлаг шийдэл', en: 'An innovative solution to take your business to the next level' },
  ...
  'contactPage.heroDesc': { mn: 'Санхүүгийн технологийн шийдлүүдийн талаар асуух зүйл байвал бидэнтэй холбогдоорой. Бид таны хүсэлтэд хариу өгөхөд бэлэн.', en: 'Contact us if you have questions about financial technology solutions. We are ready to respond to your requests.' },
  ...
  'aboutPage.heroDesc': { mn: '2021 оноос хойш банк санхүүгийн салбарт технологийн шилдэг шийдлүүдийг бүтээж, Монголын санхүүгийн дэд бүтцийг хөгжүүлж байна.', en: 'Since 2021, we have been building the best technology solutions in the banking and finance sector, developing Mongolia\'s financial infrastructure.' },
  ...
  'aboutPage.qualityDesc': { mn: 'Бид хийсэн бүх ажилдаа дээд зэргийн стандартыг баримтална, кодын чанараас эхлээд харилцагчтай харилцах хүртэл.', en: 'We uphold the highest standards in all our work, from code quality to client relations.' },
  ...
  'aboutPage.milestone.2021Desc': { mn: 'ФИБА ХХК байгуулагдаж, банк санхүүгийн програм хангамжийн чиглэлээр үйл ажиллагаагаа эхэлсэн.', en: 'FIBA LLC was founded and began operations in banking software development.' },
  'aboutPage.milestone.2022': { mn: 'Анхны гэрээ', en: 'First Contract' },
  'aboutPage.milestone.2022Desc': { mn: 'Анхны томоохон банктай гэрээ байгуулж, Core Banking систем нэвтрүүлсэн.', en: 'Signed the first major contract with a bank and implemented a Core Banking system.' },
  'aboutPage.milestone.2023': { mn: 'Бүтээгдэхүүн өргөжилт', en: 'Product Expansion' },
  'aboutPage.milestone.2023Desc': { mn: 'MeLP зээлийн систем болон MeAPP мобайл аппликейшн гаргасан.', en: 'Launched MeLP loan system and MeAPP mobile application.' },
  'aboutPage.milestone.2024': { mn: 'SmartWare нэвтрүүлэлт', en: 'SmartWare Launch' },
  'aboutPage.milestone.2024Desc': { mn: 'POS терминалын шийдэл SmartWare-г зах зээлд нэвтрүүлсэн.', en: 'Introduced the POS terminal solution SmartWare to the market.' },
  'aboutPage.milestone.2025': { mn: 'SainScore хөгжүүлэлт', en: 'SainScore Development' },
  'aboutPage.milestone.2025Desc': { mn: 'Зээлийн мэдээллийн систем SainScore-г хөгжүүлж, санхүүгийн салбарт нэвтрүүлсэн.', en: 'Developed and introduced the credit information system SainScore to the financial sector.' },
  'aboutPage.milestone.2026': { mn: 'Салбарын тэргүүлэгч', en: 'Industry Leader' },
  'aboutPage.milestone.2026Desc': { mn: 'Монголын санхүүгийн технологийн салбарт тэргүүлэгч компани болсон.', en: 'Became the leading company in Mongolia\'s financial technology sector.' },
  ...
  'footer.desc': { mn: 'Банк санхүүгийн програм хангамж, төлбөр тооцооны систем, мэдээллийн сан зохион байгуулах чиглэлээр 2021 оноос үйл ажиллагаа явуулж байна.', en: 'Operating since 2021 in banking software, payment systems, and database management.' },
  ...
  'notFound.desc': { mn: 'Уучлаарай! Таны хайсан хуудас олдсонгүй.', en: 'Oops! The page you are looking for does not exist.' },
